  ...
  return (
    <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
      {Lookup.PRICING_OPTIONS.map((pricing, index) => (
        <div
          className="flex flex-col gap-6 border rounded-xl p-10 justify-between bg-gray-800 text-white transition-transform transform hover:scale-105 hover:shadow-lg hover:border-indigo-500 hover:cursor-pointer"
          key={index}
        >
          <h2 className="font-bold text-4xl text-indigo-400">{pricing.name}</h2>
